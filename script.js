...
function initializeDefaultMembers() {
        ...
        try {
            ...
            if (!members['7']) {
                members['7'] = {
                    name: 'Liu Xiehan',
                    role: 'Team Member',
                    avatar: 'images/liu-xiehan-avatar.jpg',
                    avatarType: 'image',
                    bio: '',
                    hobbies: [],
                    email: '',
    ...
    console.log('✅ Successfully initialized 7 team members: Wang Chengle, Chen Kangwen, Chen Yuzhe, Ge Chengfei, Wu Changhong, Zhu Yihong, Liu Xiehan');
}
...
function updateHomepageStats() {
    ...
    // Always count Exercise 1, Exercise 2, Exercise 3, Exercise 4, Exercise 5, and Exercise 6 as active assignments
    let activeAssignments = assignments.filter(a => a.status !== 'completed').length;
    
    // If no assignments in localStorage, count all 6 exercises as active
    if (activeAssignments === 0) {
        activeAssignments = 6; // exercise1-edit.html, exercise2-arduino-input-output.html, exercise3-cad-fusion360.html, exercise4-material-tool.html, exercise5-3d-printing.html, and exercise6-iot-interaction.html
    }
